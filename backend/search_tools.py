...
class CourseSearchTool(Tool):
    ...
    def _format_results(self, results: SearchResults) -> str:
        ...
        for doc, meta in zip(results.documents, results.metadata):
            ...
            # Try to get lesson link first (if lesson number exists)
            link = None
            if lesson_num is not None:
            ...
            source = {
                "text": source_text,
                "link": link  # Can be None if no link available
            }
...
class CourseOutlineTool(Tool):
    """Tool for getting course outlines - title, link, and lesson list"""
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        return {
            ...
            "description": "Get the outline of a course including title, course link, and complete lesson list with lesson numbers and titles. Use this for questions about course structure, available lessons, or course overview.",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_name": {
    ...
    def execute(self, course_name: str) -> str:
        ...
        for lesson in outline['lessons']:
            result += f"  {lesson['lesson_number']}. {lesson['lesson_title']}\n"
